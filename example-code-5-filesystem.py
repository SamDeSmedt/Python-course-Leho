...
newdir = "/media/sf_VMshare/Python-scripts/HTA/newdir/"
os.mkdir(newdir)
...
location = "/media/sf_VMshare/Python-scripts/HTA/fastqc/"
os.chdir(location)
...
iternames = glob.iglob("/media/sf_VMshare/Python-scripts/**/*.py",recursive=True)
